...
#include "scheduler.h" /* typedef sche_t, */
#include "pq_by_heap.h" /* container of scheduler and API use */
...
{
	return (int)(difftime(TaskGetTimeToRun((task_t *)a)
											,TaskGetTimeToRun((task_t *)b)));
}
